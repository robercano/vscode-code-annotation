...
export class NotesTree implements vscode.TreeDataProvider<NoteItem> {
    private _onDidChangeTreeData: vscode.EventEmitter<NoteItem | undefined | null | void> = new vscode.EventEmitter<
    ...
    sourceData(): void {
        ...
        this.data = [];
        this.data = [
            new NoteItem("Pending", undefined, undefined, "$menu-pending"),
            new NoteItem("Done", undefined, undefined, "$menu-done"),
        ];
    ...
    editItem(id: string | undefined): void {
        ...
        vscode.window
            .showInputBox({ placeHolder: "New text for annotation...", value: notes[index].text })
            .then((annotationText) => {
